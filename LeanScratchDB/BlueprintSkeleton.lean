...
/-- **Physical Postulate 1** [Paper_I_Mathematical_Foundations.tex]: Inflationary Observables
    Statement: \label{thm:inflation} For $N_e = 55$ e-folds on the $T^2$ fiber plateau, the tensor-to-scalar ratio and spectral index are: \begin{equation} r = \frac{12}{N_e^2} = 0.00396 \pm 0.00015, \qquad n_s = 1 - \frac{2}{N_e} = 0.9636 \end{equation} The uncertainty in $r$ propagates from $\Delta N_e = \pm 1$. -/
